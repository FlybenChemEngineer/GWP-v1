...
print(f"Predicted value for SMILES (GWP100) '{smiles_input}': {predicted_value}")
...
# 批量计算预测值
df['predicted_gwp100'] = df['smiles'].apply(predict_smiles)

# 保存到新的CSV文件
output_file = 'gwp100_smiles_predictions.csv'
