...
# Initialize the best model with the saved hyperparameters
...
print(f"Predicted value for SMILES (GWP500) '{smiles_input}': {predicted_value}")
'''
...
# 批量计算预测值
df['predicted_gwp500'] = df['smiles'].apply(predict_smiles)

# 保存到新的CSV文件
output_file = 'gwp500_smiles_predictions.csv'
